...
class LinkedInService {
     ...
     */
    async getUserProfile(token: string): Promise<{ urn: string; name: string }> {
     ...
     */
    private async uploadImage(urn: string, token: string, imageUrl: string): Promise<string> {
        // 1. Register Upload
        const registerBody = {
     ...
     */
    async getMetrics(urn: string, token: string, postUrl: string): Promise<any> {
